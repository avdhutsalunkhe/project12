...
async def run():
    ...
    req1 = ChatRequest(messages=[
        ChatMessage(role=MessageRole.USER, content="I need a Python developer assessment."),
        ChatMessage(role=MessageRole.ASSISTANT, content="Based on the skills you mentioned, are you hiring for a specific role like a Python Developer?"),
        ChatMessage(role=MessageRole.USER, content="Yes, exactly, mid-level seniority.")
    ])
